...
function (dojo, declare) {
    return declare("bgagame.catcafe", ebg.core.gamegui, {
        constructor: function(){
            // console.log('catcafe constructor');
            ...
            this.tooltip_shape = [
                _("CAT HOUSE: After you mark a house on the sheet, choose a Cat that has not yet been 'scored'. You then immediately score 2 points for each of the items you've " +
                ...
                _("BALL OF YARN: At the end of the game, count the number of Balls of Yarn in each Cat Tower. Players with the most in each Cat Tower get 8 points. If a " +
                ...
                _("BUTTERFLY TOY: A Butterfly Toy gives you two unmarked footprints. These footprints are then considered available for " +
                "you to use in future rounds. At the end of the game, you score 3 points for each Butterfly Toy."),
            
                _("FOOD BOWL: At the end of the game, Food bowls score 1 point for each different adjacent item."),
            
                _("CUSHION: At the end of the game, each Cushion scores points equal to the floor number it is drawn in."),
            
                _("MOUSE TOY: At the end of the game, you receive 2/6/12/20 points depending on the number of adjacently connected Mouse Toys in a 'chain'. Each " + 
        ...
        setup: function( gamedatas )
        {
            ...
            for( var player_id in gamedatas.players )
            {
                ...
                for (let i=1; i<7; i++) {
                    ...
                    this.addTooltip( 'shape_selection_'+player_id+'_'+i, _(this.tooltip_shape[i-1]), '' );
                }
...
*/
        ...
        onClickPlayerDice: function( elmt_id ) {
            ...
            if ( this.isCurrentPlayerActive() ) {
                this.ajaxcall( "/catcafe/catcafe/chooseDiceForLocation.html", { lock: true, player_id: player_id, num_player_dice: num_player_dice, dice_face: dice_face }, this, function( result ) {}, function( is_error ) {} );
            }
        },
        ...
        onClickSquare: function( node_id )
        {
            ...
            if ( this.isCurrentPlayerActive() ) {
                this.ajaxcall( "/catcafe/catcafe/chooseDrawingLocation.html", { lock: true, player_id: player_id, x: x, y: y }, this, function( result ) {}, function( is_error ) {} );
            }
        },
        ...
        onClickShape: function( elmt_id )
        {
            ...
            if ( this.isCurrentPlayerActive() ) {
                this.ajaxcall( "/catcafe/catcafe/chooseShape.html", { lock: true, player_id: player_id, shape: shape }, this, function( result ) {}, function( is_error ) {} );
            }
        },
        ...
        onClickCat: function( elmt_id )
        {
            ...
            if ( this.isCurrentPlayerActive() ) {
                this.ajaxcall( "/catcafe/catcafe/chooseCat.html", { lock: true, player_id: player_id, cat: cat }, this, function( result ) {}, function( is_error ) {} );
            }
        },
